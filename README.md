...
**Playground** คือ ตัวช่วยสำหรับการเรียนรู้ภาษา Swift ที่ดีที่สุด เนื่องจากมีระบบโต้ตอบอัตโนมัติที่จะทำให้เวลาที่เราเขียนคำสั่งในภาษา Swift แล้วจะสามารถแสดงผลลัพธ์ให้เราเห็นได้ทันที ดาวน์โหลดไฟล์ PlaygroundBasics และเปิดไฟล์เพื่อทดลองทำแบบฝึกปฏิบัติ โดยใช้โปรแกรม Xcode
